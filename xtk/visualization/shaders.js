...
X.shaders = function() {
  ...
  t += 'attribute vec4 vertexTransform0,vertexTransform1,vertexTransform2,vertexTransform3;\n';
  t += '\n';
  t += 'uniform mat4 view;\n';
  ...
  t += '  vec4 transformedVertexPosition;\n';
  t += '  transformedVertexPosition.x = dot(vec4(vertexPosition, 1.0),vertexTransform0);\n';
  t += '  transformedVertexPosition.y = dot(vec4(vertexPosition, 1.0),vertexTransform1);\n';
  t += '  transformedVertexPosition.z = dot(vec4(vertexPosition, 1.0),vertexTransform2);\n';
  t += '  transformedVertexPosition.w = dot(vec4(vertexPosition, 1.0),vertexTransform3);\n';
  t += '  gl_Position = perspective * view * transformedVertexPosition;\n';
