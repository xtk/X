...
/**
 * Create a parser for the binary .STL format. Original embodiment by Matthew
 * Goodman (meawoppl@gmail.com)
 * 
 * @constructor
 * @extends X.parser
 */
...
X.parserBINSTL.prototype.parse = function(container, object, data, flag) {
  ...
  // Following the header is a 4 byte unsigned integer indicating the number of
  // triangular facets in the file.
...
goog.exportSymbol('X.parserBINSTL.prototype.parse',
    X.parserBINSTL.prototype.parse);
